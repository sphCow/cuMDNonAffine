...
void ThermostatBDP::set(double taut_) {
	taut = taut_;
	std::cout << "BDP Thermostat initialized with tau_t = " << taut << std::endl;
}

double ThermostatBDP::resamplekin(double kk, double sigma, unsigned long ndeg) {
/*
...
double ThermostatBDP::resamplekin_sumnoises(int nn) {
/*
...
double ThermostatBDP::gamdev(const int ia) {
    int j;
